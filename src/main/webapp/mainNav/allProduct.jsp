...
<body>
    <div id="wrap">
        ...
        <div id="section">
        	<div id="topList" align="center" style="font-size:20pt;">상의</div>
	  		<table>
	        	<c:forEach var="i" begin="0" end="${topImaList.size() -1 }" step="1">
       				<c:if test="${i%4==0 }">
       					<tr>
       						<td>
					       		<a class="modal_show" href="/radiant/stock/stockMainForm.do"><img src="/radiant/img/clothes/${topImaList[i] }" alt="${topImaList[i] }" class="img"></a>
		       					<p>${topList[i].clName }</p>
		       					<p>${topList[i].price }</p>
		       				</td>
       				</c:if>
       				<c:if test="${i%4 ==3 }">
					...
					<c:if test="${i == topImaList.size() -1 }">
						</tr>
					</c:if>
	        	</c:forEach>
        	</table>
        	
        	<div id="pantsList" align="center" style="font-size:20pt;">하의</div>
	  		<table>
	        	<c:forEach var="i" begin="0" end="${pantsImaList.size() -1 }" step="1">
       				<c:if test="${i%4==0 }">
       					<tr>
       						<td>
					       		<a class="modal_show" href="/radiant/stock/stockMainForm.do"><img src="/radiant/img/clothes/${pantsImaList[i] }" alt="${pantsImaList[i] }" class="img"></a>
		       					<p>${pantsList[i].clName }</p>
		       					<p>${pantsList[i].price }</p>
		       				</td>
       				</c:if>
       				<c:if test="${i%4 ==3 }">
		       				<td>
					...
					<c:if test="${i == pantsImaList.size() -1 }">
						</tr>
					</c:if>
	        	</c:forEach>
        	</table>
        	
        	<div id="outerList" align="center" style="font-size:20pt;">아우터</div>
	  		<table>
	        	<c:forEach var="i" begin="0" end="${outerImaList.size() -1 }" step="1">
       				<c:if test="${i%4==0 }">
       					<tr>
       						<td>
					       		<a class="modal_show" href="/radiant/stock/stockMainForm.do"><img src="/radiant/img/clothes/${outerImaList[i] }" alt="${outerImaList[i] }" class="img"></a>
		       					<p>${outerList[i].clName }</p>
		       					<p>${outerList[i].price }</p>
		       				</td>
       				</c:if>
       				<c:if test="${i%4 ==3 }">
		       				<td>
					...
					<c:if test="${i == outerImaList.size() -1 }">
						</tr>
					</c:if>
	        	</c:forEach>
        	</table>
