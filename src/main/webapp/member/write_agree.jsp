...
#joinForm{width: 60%;margin: 0 auto;}
...
<body>
   <div id="wrap">
	...
	<form name="joinForm" id="joinForm" method="post" action="http://localhost:8080/radiant/member/writeForm.do" >
            ...
            <textarea name="" id="">이용약관
            
제1조(목적)
이 약관은 레디언트 회사(전자상거래 사업자)가 운영하는 레디언트 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리,의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
① "몰" 이란 레디언트 회사가 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
제29조 할인쿠폰
①할인쿠폰은 레디언트가 무상으로 발행하는 쿠폰으로 발행대상, 발행경로, 사용대상 등에 따라 구분될 수 있으며, 할인쿠폰의 세부구분, 할인금액(할인율), 사용방법, 사용기한 및 제한에 대한 사항은 할인쿠폰 또는 서비스 화면에 표시됩니다. 할인쿠폰의 종류 및 내용과 발급 여부는 레디언트의 서비스 정책에 따라 변경될 수 있습니다.
②할인쿠폰은 현금으로 출금될 수 없으며, 할인쿠폰에 표시된 유효기간이 만료되거나 회원자격이 상실되면 소멸합니다.
③할인쿠폰은 레디언트에서 별도로 명시한 경우를 제외하고는 타인에게 양도할 수 없으며, 부정한 목적이나 용도로 사용할 수 없습니다. 이를 위반한 경우 레디언트는 할인쿠폰을 소멸시키거나 회원자격을 제한 또는 상실시킬 수 있습니다.
④회원이 부정한 방법으로  적립금 또는 할인쿠폰을 획득한 사실이 확인될 경우, 회원의 적립금 또는 할인쿠폰을 회수하고, 회원자격 상실(아이디 삭제) 및 민?형사 상의 법적 조치 등을 취할 수 있습니다.

제30조 마케팅 정보 수신 동의
레디언트 개인정보보호법 및 정보통신망이용촉진및정보보호등에관한법률 등 관계법령에 따라 광고성정보를 전송하기 위해 수신자의 사전 수신동의를 받고 있으며, 광고성정보 수신자 의 수신동의여부를 정기적으로 확인합니다.

- 전송방법
 고객님의 모바일 App Push, 핸드폰 문자메시지(SMS), Email,카카오톡(알림톡,브랜드톡)등을 통해 전달될 수 있습니다.
- 전송내용
 발송되는 마케팅 정보는 수신자에게 레디언트과 관련하여 제공하는 혜택(포인트, 쿠폰 등) 정보, 각종 이벤트 정보 등 광고성 정보로 관련 법의 규정을 준수하여 발송됩니다. 단, 광고성 정보 이외 의무적으로 안내되어야 하는 정보성 내용은 수신동의 여부와 무관하게 제공됩니다.
- 철회안내
 고객님은 수신 동의 이후에라도 의사에 따라 동의를 철회할 수 있으며, 수신을 동의하지 않아도 회사가 제공하는 기본적인 서비스를 이용할 수 있으나, 당사의 마케팅 정보를 수신하지 못할 수 있습니다.
- 수신동의 변경
 레디언트 홈페이지(www.attrangs.co.kr) 또는 레디언트 고객센터(02-1644-3225)을 통해 수신동의를 변경(동의/철회)할 수 있습니다.
- 개인정보 이용 상세내용
 이용하는 개인정보 - 보유 이용 목적
 휴대전화번호,이메일주소,카카오톡 - 혜택 정보,각종 이벤트 정보 등 광고성 정보 제공

부 칙(시행일)
이 약관은 2020 년 1월 1일부터 시행합니다.
</textarea>
			                </li>
			                <li class="checkBox check03">
			                    <ul class="clearfix">
...
<textarea name="" id="">개인정보처리방침

'레디언트'은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.	회사는 개인정보처리방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다. 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.
...
■ 수집한 개인정보의 위탁 
회사는 고객서비스 관리 및 민원사항에 대한 등 원활한 업무 수행을 위하여 아래와 같이 개인정보 취급 업무를 위탁하여 운영하고 있습니다. 또한 위탁계약 시 개인정보보호의 안전을 기하기 위하여 개인정보보호 관련 법규의 준수, 개인정보에 관한 제3자 공급 금지, 사고시의 책임부담 등을 명확히 규정하고 있습니다. 동 업체가 변경될 경우, 변경된 업체 명을 공지사항 내지 개인정보 처리방침 화면을 통해 고지하겠습니다.

- 대한통운 : 주문 상품 배송
- 위사 : 호스팅 시스템 구축 및 유지
- 이니시스 : 결제 및 에스크로 서비스
- 바나나앤팩토리 : 후기작성 시스템
- 루나소프트 : 정보성 메시지 카카오톡 알림톡 발송 업무, 네이버 톡톡(정보성 메시지) 발송 업무 및 톡 기반 상담 서비스 제공
- SIIC Inc / Simplex Sientific Technology Co., Ltd. : 레디언트 고객상담업무
- (주)데이터라이즈 : SMS, 카카오톡 채널 및 E-mail 안내에 필요한 정보, 정보 안내 및 이벤트 전달 서비스 업무

■ 이용자 및 법정대리인의 권리와 그 행사방법 
이용자 및 법정 대리인은 언제든지 등록되어 있는 자신 혹은 당해 만 14세 미만 아동의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다. 이용자 혹은 만 14세 미만 아동의 개인정보 조회,수정을 위해서는 "개인정보변경"(또는 "회원정보수정" 등)을 가입해지(동의철회)를 위해서는 "회원탈퇴"를 클릭 하여 본인확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다. 혹은 개인정보관리책임자에게 서면, 전화 또는 이메일로 연락하시면 지체없이 조치하겠습니다. 귀하가 개인정보의 오류에 대한 정정을 요청하신 경우에는 정정을 완료하기 전까 지 당해 개인정보를 이용 또는 제공하지 않습니다. 또한 잘못된 개인정보를 제3자 에게 이미 제공한 경우에는 정정 처리결과를 제3자에게 지체없이 통지하여 정정이 이루어지도록 하겠습니다. 레디언트는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 "레디언트가 수집하는 개인정보의 보유 및 이용기간"에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.

■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항 
회사는 귀하의 정보를 수시로 저장하고 찾아내는 "쿠키(cookie)" 등을 운용합니다. 쿠키란 레디언트의 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다. 회사은(는) 다음과 같은 목적을 위해 쿠키를 사용합니다.
- 쿠키 등 사용 목적
...
고객서비스담당부서 :레디언트 고객센터전화번호 : 02-1644-3225이메일 : radiant@naver.com
개인정보관리책임자성명 : 윤시영전화번호 : 02-1644-3225이메일 : radiant@naver.com

귀하께서는 회사의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련 민원을 개인정보관리책임자 혹은 담당부서로 신고하실 수 있습니다. 회사는 이용자들의 신고사항에 대해 신속하게 충분한 답변을 드릴 것입니다. 
기타 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에 문의하시기 바랍니다.

1.정보보호마크인증위원회 (http://www.eprivacy.or.kr)
2.경찰청 사이버안전국 (http://cyberbureau.police.go.kr)
    </textarea>
                </li>
            </ul>
